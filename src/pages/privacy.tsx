      ...
      <div>
        ...
        <BodyWrapper>
          <section>
            ...
            <H3>Definitions</H3>
            <Paragraph1>For the purposes of this Privacy Policy:</Paragraph1>
            <Paragraph1>
            ...
            <Paragraph1>* Country refers to: Georgia</Paragraph1>
            <Paragraph1>
            ...
            <Paragraph1>* Service refers to the Website.</Paragraph1>
            <Paragraph1>
            ...
            <Paragraph1>
              * Website refers to maxdyy, accessible from{' '}
              <StyledLink
                target="_blank"
                rel="noreferrer"
                href="https://www.maxdyy.com"
              >
                https://www.maxdyy.com
              </StyledLink>
            </Paragraph1>
            <Paragraph1>
            ...
            <Paragraph1>* Email address</Paragraph1>
            <Paragraph1>* First name and last name</Paragraph1>
            <Paragraph1>* Phone number</Paragraph1>
            <Paragraph1>
              * Address, State, Province, ZIP/Postal code, City
            </Paragraph1>
            <Paragraph1>* Usage Data</Paragraph1>
            <H4>Usage Data </H4>
            <Paragraph1>
            ...
            <Paragraph1>
              ...
              >
                Use of Cookies by Free Privacy Free
              </StyledLink>
              .
            </Paragraph1>
            <Paragraph1>
            ...
            <Paragraph1>
              * By visiting this page on our website:{' '}
              <StyledLink
                target="_blank"
                rel="noreferrer"
                href="https://www.maxdyy.com/contact"
              >
